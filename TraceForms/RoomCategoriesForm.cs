...
namespace TraceForms
{
    public partial class RoomCategoriesForm : XtraForm
    {
            ...
            try {
                ...
                if (modified) {
                    ...
                    if (_selectedRecord.EntityState == EntityState.Detached) {
                        _context.ROOMCOD.AddObject(_selectedRecord);
                    }
        ...
        private bool IsModified(ROOMCOD record)
        {
        ...
        void SetBindings()
        {
            ...
            if (BindingSource.Current == null) {
                ...
                _selectedRecord = ((ROOMCOD)BindingSource.Current);
                SetReadOnly(false);
                SetReadOnlyKeyFields(true);
            }
            ErrorProvider.Clear();
        ...
        private void ShowMainControlErrors()
        {
            ...
            SetErrorInfo(_selectedRecord.ValidateLongDescription, TextBoxLongDescription);
        }
        ...
        void ClearBindings()
        {
            BindingSource.DataSource = typeof(ROOMCOD);
        }
        ...
        private void TextEditLongDescription_Leave(object sender, EventArgs e)
        {
            if (_selectedRecord != null)
                SetErrorInfo(_selectedRecord.ValidateLongDescription, sender);
        }
        ...
        private void ExecuteQuery()
        {
            ...
            var records = _context.ROOMCOD.Where(query);
            if (records.Count() > 0) {
